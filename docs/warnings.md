!!! warning
    ...
    - OhMyDebn will not remove any existing apps by default, but if you use the [`--power-user` option](installation.md#installation-options), it will remove apps like Firefox, Thunderbird, LibreOffice, and others
