...
The OhMyDebn menu allows you to launch apps, learn about OhMyDebn, and configure and control the system. You can activate this menu from the Cinnamon menu or by pressing `Super + Alt + Space`.
