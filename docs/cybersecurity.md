...
SO-CRATES has a theme sync option. If you enable this option then, whenever you change your OhMyDebn theme, the SO-CRATES theme will automatically update as well.

You can read more about SO-CRATES at <https://so-crates.org>.
